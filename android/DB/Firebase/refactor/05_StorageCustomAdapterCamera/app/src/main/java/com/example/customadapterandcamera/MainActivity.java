...
public class MainActivity extends AppCompatActivity {
	...
	Button createUsers, addNewUser, takePicture;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		createUsers = findViewById(R.id.createUsersButton);
		addNewUser = findViewById(R.id.addNewUserButton);
		name = findViewById(R.id.userName);
		takePicture = findViewById(R.id.takePicture_button);
		imageView = findViewById(R.id.activityMain_userPicture);
